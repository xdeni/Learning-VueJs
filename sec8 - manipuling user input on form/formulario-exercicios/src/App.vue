		...
		<div class="conteudo">
			<form v-if="!enviado" class="painel">
				...
				<Rotulo nome="Características do Problema">
					<span class="mr-4"><input v-model="caracteristicas" type="checkbox" value="reproduzivel"> Reproduzível</span>
					<span><input v-model="caracteristicas" type="checkbox" value="intermitente"> Intermitente</span>
				</Rotulo>
				...
				<Rotulo nome="Prioridade">
					<select v-model="prioridade" name="" id="">
						<option v-for="p in prioridades" :key="p.codigo">{{p.value}}</option>
					</select>
				</Rotulo>
				<Rotulo nome="Primeira Reclamação?">
					<Escolha @input="reclamacao = $event" :value="reclamacao"/>
				</Rotulo>
				<hr>
...
export default {
	...
	data () {
		return {
			...
			prioridade:'Baixa',
			prioridades: [
				{ codigo: 1, value:'Baixa' }, 
				{ codigo: 2, value:'Moderada' },
				{ codigo: 3, value: 'Alta'}
			],
			produto: 'Web',
			caracteristicas: [],
